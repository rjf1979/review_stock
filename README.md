...
- [Windows 64 位安装包](https://my-soft-2026.oss-cn-shanghai.aliyuncs.com/files/hangqing-desktop-0.3.0-win-x64-setup.exe)：适用于绝大多数 Windows 10/11 电脑，经阿里云 OSS 加速。
- [Windows 32 位安装包](https://my-soft-2026.oss-cn-shanghai.aliyuncs.com/files/hangqing-desktop-0.3.0-win-ia32-setup.exe)：仅用于 32 位 Windows。
- [备用镜像一（gh-proxy）](https://gh-proxy.com/https://github.com/rjf1979/review_stock/releases/download/v0.3.0/hangqing-desktop-0.3.0-win-x64-setup.exe) · [备用镜像二（ghfast）](https://ghfast.top/https://github.com/rjf1979/review_stock/releases/download/v0.3.0/hangqing-desktop-0.3.0-win-x64-setup.exe) · [GitHub Release 与全部版本](https://github.com/rjf1979/review_stock/releases)。

主下载经阿里云 OSS 加速，速度稳定；若失效请改用上面的备用镜像或 GitHub Release 原站链接。安装包暂未进行代码签名，Windows 可能显示“未知发布者”提示，请下载后核对发布页提供的 SHA-256。
...
桌面版当前版本为 `0.3.0`。构建目录和安装包输出到 `src/desktop/release/`，该目录已被 Git 忽略。
