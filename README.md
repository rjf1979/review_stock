...
- [Windows 64 位安装包](https://github.com/rjf1979/review_stock/releases/download/v0.2.6/hangqing-desktop-0.2.6-win-x64-setup.exe)：适用于绝大多数 Windows 10/11 电脑。
- [Windows 32 位安装包](https://github.com/rjf1979/review_stock/releases/download/v0.2.6/hangqing-desktop-0.2.6-win-ia32-setup.exe)：仅用于 32 位 Windows。
...
桌面版当前版本为 `0.2.6`。构建目录和安装包输出到 `src/desktop/release/`，该目录已被 Git 忽略。
