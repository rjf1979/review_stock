...
const downloads = {
  assistant: 'https://oss.askcode.cn/files/hangqing-installer-0.3.14-win.exe',
  assistantBackup: 'https://github.com/rjf1979/review_stock/releases/download/v0.3.14/hangqing-installer-0.3.14-win.exe',
  x64: 'https://oss.askcode.cn/files/hangqing-desktop-0.3.14-win-x64-setup.exe',
  ia32: 'https://oss.askcode.cn/files/hangqing-desktop-0.3.14-win-ia32-setup.exe',
  x64Backup: 'https://github.com/rjf1979/review_stock/releases/download/v0.3.14/hangqing-desktop-0.3.14-win-x64-setup.exe',
  ia32Backup: 'https://github.com/rjf1979/review_stock/releases/download/v0.3.14/hangqing-desktop-0.3.14-win-ia32-setup.exe',
  x64Backup2: 'https://my-soft-2026.oss-cn-shanghai.aliyuncs.com/files/hangqing-desktop-0.3.14-win-x64-setup.exe',
  ia32Backup2: 'https://my-soft-2026.oss-cn-shanghai.aliyuncs.com/files/hangqing-desktop-0.3.14-win-ia32-setup.exe',
  release: 'https://github.com/rjf1979/review_stock/releases/tag/v0.3.14'
}
  ...
  <div class="app-shell">
    ...
    <main>
      ...
      <section id="download" class="download-section">
        <div><p class="kicker">DESKTOP RELEASE · V0.3.14</p><h2>把股市脉搏放在桌面上</h2><p>推荐使用统一安装应用：自动检查环境、匹配 x64 / x86、显示下载进度、校验文件后启动安装向导。也可按架构手动下载。macOS 暂未提供，安装包未签名，请核对发布页 SHA-256。</p></div>
